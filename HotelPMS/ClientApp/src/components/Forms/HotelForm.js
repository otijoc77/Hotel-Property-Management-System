    ...
    return (
        <Layout>
            <div className="w-100 d-table">
                <h1 id="header" className="d-table-cell">Register hotel</h1>
            ...
            <form>
                ...
                <div className="form-group">
                    ...
                    <small id="imageHelp" className="form-text text-muted">Optional image url for hotel.</small>
                </div>
                <div className="form-group">
                    <label>City:</label>
                ...
                <div className="row w-50">
                    <div className="form-group col">
                        ...
                        <input type="number" name="latitude" className="form-control w-100" value={latitude} onChange={(e) => setLatitude(e.target.value)} required />
                        <small id="latitudeHelp" className="form-text text-muted">Range from -90 to 90.</small>
                    </div>
                    <div className="form-group col">
                        <label>Longitude:</label>
                        <input type="number" name="longitude" className="form-control w-100" value={longitude} onChange={(e) => setLongitude(e.target.value)} required />
