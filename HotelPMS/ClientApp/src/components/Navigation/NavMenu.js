...
export function NavMenu() {
	...
	return (
		<ListGroup flush className="flex-grow-1 separate">
			...
			{cookies.level != "Client" && cookies.level != undefined && (
				<>
					{cookies.level != "Worker" && (
						<NavItem>
							<NavLink tag={Link} className="text-dark" to="/metrics">
								<b>
					...
					{cookies.level == "Admin" && (
						<NavItem>
							<NavLink tag={Link} className="text-dark" to="/location-register">
								<b>
			...
			<UncontrolledAccordion flush stayOpen defaultOpen={["1"]}>
				<AccordionItem>
					...
					<AccordionBody accordionId="1">
						<NavItem>
							<NavLink tag={Link} className="text-dark" to="/company-list">
								Company List
							</NavLink>
						</NavItem>
						{cookies.level == "Admin" && (
			...
			<NavItem>
				<NavLink tag={Link} className="text-dark" to="/hotel-list">
					<b>
					...
					<NavItem>
						<NavLink tag={Link} className="text-dark" to="/users">
							<b>
								...
								{cookies.level == "Admin" ? "Users" : "Employees"}
							</b>
						</NavLink>
					</NavItem>
				)}
