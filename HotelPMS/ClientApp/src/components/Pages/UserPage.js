...
export function UserPage() {
    ...
    return (
        <Layout>
            {!state.loading &&
                <Container>
                    <h1><em>{cookies.name}</em></h1>
                    <div className="card p-3 margin-b-20">
                        <Row>
                            <Col>
                                <label>Name:</label>
                                <p className="bold">{state.user.name} {state.user.surname}</p>
                            </Col>
                            <Col>
                                <label>Gender:</label>
                        ...
                        <Row>
                            <Col>
                                <label>Email:</label>
                                <p className="bold">{state.user.email ? state.user.email : "-"}</p>
                            </Col>
                            <Col>
                                <label>Phone number:</label>
                                <p className="bold">{state.user.phoneNumber ? state.user.phoneNumber : "-"}</p>
                            </Col>
                        </Row>
                    </div>
